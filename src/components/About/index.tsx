...
function About() {
    return (
        <section id="about" className="page-section">
            ...
            <div>
                <span>Born in Southern California, I discovered my passion for programming in my senior year of highschool after joining the <span className="highlight">FIRST robotics team.</span></span>
                ...
                <span>Outside coding, <span className="highlight">I enjoy staying active</span>,&nbsp;
